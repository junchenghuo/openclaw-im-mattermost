...
export function makeSortChannelsByNameWithDMs(): (state: GlobalState, channels: Channel[]) => Channel[] {
    return createSelector(
        ...
        (state: GlobalState) => getCurrentUserLocale(state),
        getMyChannelMemberships,
        (channels: Channel[], currentUserId: string, profiles: IDMappedObjects<UserProfile>, _teammateNameDisplay: string, locale: string, myMembers: RelationOneToOne<Channel, ChannelMembership>) => {
            ...
            const getDisplayName = (channel: Channel): string => {
                ...
                if (channel.type === General.DM_CHANNEL) {
                    ...
                    displayName = displayUsername(teammate, General.TEAMMATE_NAME_DISPLAY.SHOW_NICKNAME_FULLNAME, false);
                    ...
                    for (const username of usernames) {
                        ...
                        userDisplayNames.push(displayUsername(user, General.TEAMMATE_NAME_DISPLAY.SHOW_NICKNAME_FULLNAME, false));
                    }
