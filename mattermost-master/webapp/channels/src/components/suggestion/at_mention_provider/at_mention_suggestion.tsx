...
const AtMentionSuggestion = React.forwardRef<HTMLLIElement, SuggestionProps<Item>>((props, ref) => {
    ...
    if (item.username === 'all') {
        ...
        itemname = item.displayName || 'channel';
        description = (
            <FormattedMessage
        ...
        itemname = item.displayName || 'here';
        description = (
            <FormattedMessage
        ...
        itemname = displayUsername(item, General.TEAMMATE_NAME_DISPLAY.SHOW_NICKNAME_FULLNAME);
